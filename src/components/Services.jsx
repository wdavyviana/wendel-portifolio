          ...
          return (
            <div key={s.n} className="flex gap-6">
              <div className="flex flex-col items-center flex-shrink-0">
                <div className="w-13 h-13 w-[52px] h-[52px] rounded-full bg-[var(--aqua-dim)] border border-[var(--aqua)] flex items-center justify-center">
                  <Icon size={22} className="text-[var(--aqua)]" />
                </div>
                {!isLast && (
              ...
              <div className={isLast ? "pb-0 pt-1" : "pb-10 pt-1"}>
                ...
                <h3 className="font-display font-semibold text-[21px] mb-1">
                  {s.title}{" "}
